...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/control-IP")
   $(echo $permited|grep "${IP}") = ""  && {
  echo -e "\n\n\n\033[1;31m====================================================="
  echo -e "\033[1;31m       ¡LA IP $(wget -qO- ipv4.icanhazip.com) NO ESTA AUTORIZADA!"
  echo -e "\033[1;31m                CONTACTE A @Jotchua_MRX"
  echo -e "\033[1;31m=====================================================\n\n\n"
   -d /etc/SCRIPT  && rm -rf /etc/SCRIPT
  exit 1
  } || {
  ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/Vercion")
...
echo -e "\033[1;31m- \033[1;32mRecibido!"
 ...
 ! -e /usr/bin/trans  && wget -O /usr/bin/trans https://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/trans &> /dev/null
...
wget https://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/gerar.sh &>/dev/null
