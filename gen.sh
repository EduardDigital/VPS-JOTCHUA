...
[[ "$MIP" != "$MIP2" https://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/control-IPhttps://raw.githubusercontent.com/EduardDigital/VPS-JOTCHUA/master-1/control-IP")
